...
from pii_detector.service.detector.model_cache import (
...
class TestGetEnvExtraModels:
    ...
    @patch('pii_detector.service.detector.model_cache.get_config')
...
class TestEnsureModelsCached:
    ...
    def test_should_skip_when_no_token(self, mock_get_config):
        ...
        with patch('pii_detector.service.detector.model_cache.logger') as mock_logger:
