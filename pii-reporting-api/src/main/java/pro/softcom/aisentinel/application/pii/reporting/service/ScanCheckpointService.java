...
public class ScanCheckpointService {
     ...
     * Spaces of the scope not started yet are paused with no starting position and
     * are scanned in full on resume.
     *
     * @param scanId the scan to pause
     * @return number of checkpoints moved to PAUSED
     */
    public int pauseUnfinishedCheckpoints(String scanId) {
        return scanCheckpointRepository.pauseUnfinishedCheckpoints(scanId);
    }
