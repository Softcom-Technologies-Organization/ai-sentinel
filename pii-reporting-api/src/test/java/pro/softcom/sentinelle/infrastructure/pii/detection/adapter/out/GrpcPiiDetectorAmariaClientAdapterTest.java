package pro.softcom.sentinelle.infrastructure.pii.detection.adapter.out;
...
import pro.softcom.sentinelle.infrastructure.pii.scan.adapter.out.GrpcPiiDetectorAmariaClientAdapter;
